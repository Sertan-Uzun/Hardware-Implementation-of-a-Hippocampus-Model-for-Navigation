// -------------------------------------------------------------
// 
// File Name: C:\Users\Sertan\Desktop\Simulink_Model\Verilog_Codes\Improved_Network_Model\OBJ7.v
...
// 
// Module: OBJ7
// Source Path: Improved_Network_Model/OBJ7
// Hierarchy Level: 1
// Model version: 1.37
// 
// -------------------------------------------------------------
...
module OBJ7
  ...
  input   reset;
  input   enb;
  input   signed [15:0] g_e_0;  // sfix16_En8
  input   signed [15:0] g_e_1;  // sfix16_En8
  input   signed [15:0] g_e_2;  // sfix16_En8
  input   signed [15:0] g_e_3;  // sfix16_En8
  input   signed [15:0] g_e_4;  // sfix16_En8
  input   signed [15:0] g_e_5;  // sfix16_En8
  input   signed [15:0] g_e_6;  // sfix16_En8
  input   signed [15:0] g_e_7;  // sfix16_En8
  input   signed [15:0] g_e_8;  // sfix16_En8
  input   signed [15:0] g_e_9;  // sfix16_En8
  input   signed [15:0] g_e_10;  // sfix16_En8
  input   signed [15:0] g_e_11;  // sfix16_En8
  input   signed [15:0] g_e_12;  // sfix16_En8
  input   signed [15:0] g_e_13;  // sfix16_En8
  input   signed [15:0] g_e_14;  // sfix16_En8
  input   signed [15:0] g_e_15;  // sfix16_En8
  input   signed [15:0] g_i;  // sfix16_En8
  output  signed [15:0] g;  // sfix16_En8


  wire signed [31:0] Sum_of_Elements_stage2_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage2_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage2_add_temp;  // sfix32_En8
  wire signed [16:0] Sum_of_Elements_op_stage1;  // sfix17_En8
  wire signed [31:0] Sum_of_Elements_stage3_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage3_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage3_add_temp;  // sfix32_En8
  wire signed [17:0] Sum_of_Elements_op_stage2;  // sfix18_En8
  wire signed [31:0] Sum_of_Elements_stage4_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage4_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage4_add_temp;  // sfix32_En8
  wire signed [18:0] Sum_of_Elements_op_stage3;  // sfix19_En8
  wire signed [31:0] Sum_of_Elements_stage5_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage5_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage5_add_temp;  // sfix32_En8
  wire signed [19:0] Sum_of_Elements_op_stage4;  // sfix20_En8
  wire signed [31:0] Sum_of_Elements_stage6_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage6_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage6_add_temp;  // sfix32_En8
  wire signed [20:0] Sum_of_Elements_op_stage5;  // sfix21_En8
  wire signed [31:0] Sum_of_Elements_stage7_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage7_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage7_add_temp;  // sfix32_En8
  wire signed [21:0] Sum_of_Elements_op_stage6;  // sfix22_En8
  wire signed [31:0] Sum_of_Elements_stage8_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage8_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage8_add_temp;  // sfix32_En8
  wire signed [22:0] Sum_of_Elements_op_stage7;  // sfix23_En8
  wire signed [31:0] Sum_of_Elements_stage9_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage9_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage9_add_temp;  // sfix32_En8
  wire signed [23:0] Sum_of_Elements_op_stage8;  // sfix24_En8
  wire signed [31:0] Sum_of_Elements_stage10_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage10_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage10_add_temp;  // sfix32_En8
  wire signed [24:0] Sum_of_Elements_op_stage9;  // sfix25_En8
  wire signed [31:0] Sum_of_Elements_stage11_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage11_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage11_add_temp;  // sfix32_En8
  wire signed [25:0] Sum_of_Elements_op_stage10;  // sfix26_En8
  wire signed [31:0] Sum_of_Elements_stage12_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage12_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage12_add_temp;  // sfix32_En8
  wire signed [26:0] Sum_of_Elements_op_stage11;  // sfix27_En8
  wire signed [31:0] Sum_of_Elements_stage13_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage13_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage13_add_temp;  // sfix32_En8
  wire signed [27:0] Sum_of_Elements_op_stage12;  // sfix28_En8
  wire signed [31:0] Sum_of_Elements_stage14_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage14_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage14_add_temp;  // sfix32_En8
  wire signed [28:0] Sum_of_Elements_op_stage13;  // sfix29_En8
  wire signed [31:0] Sum_of_Elements_stage15_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage15_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage15_add_temp;  // sfix32_En8
  wire signed [29:0] Sum_of_Elements_op_stage14;  // sfix30_En8
  wire signed [31:0] Sum_of_Elements_stage16_add_cast;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage16_add_cast_1;  // sfix32_En8
  wire signed [31:0] Sum_of_Elements_stage16_add_temp;  // sfix32_En8
  wire signed [15:0] Sum_of_Elements_out1;  // sfix16_En8
  ...
  wire signed [31:0] dtc_out;  // sfix32_En8
  ...
  wire signed [31:0] Product_out1;  // sfix32_En16
  wire signed [63:0] Gain1_out1;  // sfix64_En49
  wire signed [63:0] Add1_stage2_in0;  // sfix64_En49
  wire signed [63:0] Add1_stage2_sub_temp;  // sfix64_En49
  wire signed [64:0] Add1_op_stage1;  // sfix65_En49
  wire signed [63:0] Add1_stage3_sub_cast;  // sfix64_En49
  wire signed [63:0] Add1_stage3_sub_cast_1;  // sfix64_En49
  wire signed [63:0] Add1_out1;  // sfix64_En49
  wire signed [127:0] Gain_mul_temp;  // sfix128_En120
  ...
  assign Sum_of_Elements_stage2_add_cast = {{16{g_e_0[15]}}, g_e_0};
  assign Sum_of_Elements_stage2_add_cast_1 = {{16{g_e_1[15]}}, g_e_1};
  assign Sum_of_Elements_stage2_add_temp = Sum_of_Elements_stage2_add_cast + Sum_of_Elements_stage2_add_cast_1;
  assign Sum_of_Elements_op_stage1 = Sum_of_Elements_stage2_add_temp[16:0];



  assign Sum_of_Elements_stage3_add_cast = {{15{Sum_of_Elements_op_stage1[16]}}, Sum_of_Elements_op_stage1};
  assign Sum_of_Elements_stage3_add_cast_1 = {{16{g_e_2[15]}}, g_e_2};
  assign Sum_of_Elements_stage3_add_temp = Sum_of_Elements_stage3_add_cast + Sum_of_Elements_stage3_add_cast_1;
  assign Sum_of_Elements_op_stage2 = Sum_of_Elements_stage3_add_temp[17:0];



  assign Sum_of_Elements_stage4_add_cast = {{14{Sum_of_Elements_op_stage2[17]}}, Sum_of_Elements_op_stage2};
  assign Sum_of_Elements_stage4_add_cast_1 = {{16{g_e_3[15]}}, g_e_3};
  assign Sum_of_Elements_stage4_add_temp = Sum_of_Elements_stage4_add_cast + Sum_of_Elements_stage4_add_cast_1;
  assign Sum_of_Elements_op_stage3 = Sum_of_Elements_stage4_add_temp[18:0];



  assign Sum_of_Elements_stage5_add_cast = {{13{Sum_of_Elements_op_stage3[18]}}, Sum_of_Elements_op_stage3};
  assign Sum_of_Elements_stage5_add_cast_1 = {{16{g_e_4[15]}}, g_e_4};
  assign Sum_of_Elements_stage5_add_temp = Sum_of_Elements_stage5_add_cast + Sum_of_Elements_stage5_add_cast_1;
  assign Sum_of_Elements_op_stage4 = Sum_of_Elements_stage5_add_temp[19:0];



  assign Sum_of_Elements_stage6_add_cast = {{12{Sum_of_Elements_op_stage4[19]}}, Sum_of_Elements_op_stage4};
  assign Sum_of_Elements_stage6_add_cast_1 = {{16{g_e_5[15]}}, g_e_5};
  assign Sum_of_Elements_stage6_add_temp = Sum_of_Elements_stage6_add_cast + Sum_of_Elements_stage6_add_cast_1;
  assign Sum_of_Elements_op_stage5 = Sum_of_Elements_stage6_add_temp[20:0];



  assign Sum_of_Elements_stage7_add_cast = {{11{Sum_of_Elements_op_stage5[20]}}, Sum_of_Elements_op_stage5};
  assign Sum_of_Elements_stage7_add_cast_1 = {{16{g_e_6[15]}}, g_e_6};
  assign Sum_of_Elements_stage7_add_temp = Sum_of_Elements_stage7_add_cast + Sum_of_Elements_stage7_add_cast_1;
  assign Sum_of_Elements_op_stage6 = Sum_of_Elements_stage7_add_temp[21:0];



  assign Sum_of_Elements_stage8_add_cast = {{10{Sum_of_Elements_op_stage6[21]}}, Sum_of_Elements_op_stage6};
  assign Sum_of_Elements_stage8_add_cast_1 = {{16{g_e_7[15]}}, g_e_7};
  assign Sum_of_Elements_stage8_add_temp = Sum_of_Elements_stage8_add_cast + Sum_of_Elements_stage8_add_cast_1;
  assign Sum_of_Elements_op_stage7 = Sum_of_Elements_stage8_add_temp[22:0];



  assign Sum_of_Elements_stage9_add_cast = {{9{Sum_of_Elements_op_stage7[22]}}, Sum_of_Elements_op_stage7};
  assign Sum_of_Elements_stage9_add_cast_1 = {{16{g_e_8[15]}}, g_e_8};
  assign Sum_of_Elements_stage9_add_temp = Sum_of_Elements_stage9_add_cast + Sum_of_Elements_stage9_add_cast_1;
  assign Sum_of_Elements_op_stage8 = Sum_of_Elements_stage9_add_temp[23:0];



  assign Sum_of_Elements_stage10_add_cast = {{8{Sum_of_Elements_op_stage8[23]}}, Sum_of_Elements_op_stage8};
  assign Sum_of_Elements_stage10_add_cast_1 = {{16{g_e_9[15]}}, g_e_9};
  assign Sum_of_Elements_stage10_add_temp = Sum_of_Elements_stage10_add_cast + Sum_of_Elements_stage10_add_cast_1;
  assign Sum_of_Elements_op_stage9 = Sum_of_Elements_stage10_add_temp[24:0];



  assign Sum_of_Elements_stage11_add_cast = {{7{Sum_of_Elements_op_stage9[24]}}, Sum_of_Elements_op_stage9};
  assign Sum_of_Elements_stage11_add_cast_1 = {{16{g_e_10[15]}}, g_e_10};
  assign Sum_of_Elements_stage11_add_temp = Sum_of_Elements_stage11_add_cast + Sum_of_Elements_stage11_add_cast_1;
  assign Sum_of_Elements_op_stage10 = Sum_of_Elements_stage11_add_temp[25:0];



  assign Sum_of_Elements_stage12_add_cast = {{6{Sum_of_Elements_op_stage10[25]}}, Sum_of_Elements_op_stage10};
  assign Sum_of_Elements_stage12_add_cast_1 = {{16{g_e_11[15]}}, g_e_11};
  assign Sum_of_Elements_stage12_add_temp = Sum_of_Elements_stage12_add_cast + Sum_of_Elements_stage12_add_cast_1;
  assign Sum_of_Elements_op_stage11 = Sum_of_Elements_stage12_add_temp[26:0];



  assign Sum_of_Elements_stage13_add_cast = {{5{Sum_of_Elements_op_stage11[26]}}, Sum_of_Elements_op_stage11};
  assign Sum_of_Elements_stage13_add_cast_1 = {{16{g_e_12[15]}}, g_e_12};
  assign Sum_of_Elements_stage13_add_temp = Sum_of_Elements_stage13_add_cast + Sum_of_Elements_stage13_add_cast_1;
  assign Sum_of_Elements_op_stage12 = Sum_of_Elements_stage13_add_temp[27:0];



  assign Sum_of_Elements_stage14_add_cast = {{4{Sum_of_Elements_op_stage12[27]}}, Sum_of_Elements_op_stage12};
  assign Sum_of_Elements_stage14_add_cast_1 = {{16{g_e_13[15]}}, g_e_13};
  assign Sum_of_Elements_stage14_add_temp = Sum_of_Elements_stage14_add_cast + Sum_of_Elements_stage14_add_cast_1;
  assign Sum_of_Elements_op_stage13 = Sum_of_Elements_stage14_add_temp[28:0];



  assign Sum_of_Elements_stage15_add_cast = {{3{Sum_of_Elements_op_stage13[28]}}, Sum_of_Elements_op_stage13};
  assign Sum_of_Elements_stage15_add_cast_1 = {{16{g_e_14[15]}}, g_e_14};
  assign Sum_of_Elements_stage15_add_temp = Sum_of_Elements_stage15_add_cast + Sum_of_Elements_stage15_add_cast_1;
  assign Sum_of_Elements_op_stage14 = Sum_of_Elements_stage15_add_temp[29:0];



  assign Sum_of_Elements_stage16_add_cast = {{2{Sum_of_Elements_op_stage14[29]}}, Sum_of_Elements_op_stage14};
  assign Sum_of_Elements_stage16_add_cast_1 = {{16{g_e_15[15]}}, g_e_15};
  assign Sum_of_Elements_stage16_add_temp = Sum_of_Elements_stage16_add_cast + Sum_of_Elements_stage16_add_cast_1;
  assign Sum_of_Elements_out1 = Sum_of_Elements_stage16_add_temp[15:0];
  ...
  assign dtc_out = {{16{g_i[15]}}, g_i};



  assign Sum_of_Elements1_out1 = dtc_out[15:0];
  ...
  assign Gain1_out1 = 32'sb01100110011001100110011001100110 * Product_out1;



  assign Add1_stage2_in0 =  - (Gain1_out1);
  assign Add1_stage2_sub_temp = Add1_stage2_in0 - Gain2_out1;
  assign Add1_op_stage1 = {Add1_stage2_sub_temp[63], Add1_stage2_sub_temp};



  assign Add1_stage3_sub_cast = Add1_op_stage1[63:0];
  assign Add1_stage3_sub_cast_1 = {{7{Add2_out1[15]}}, {Add2_out1, 41'b00000000000000000000000000000000000000000}};
  assign Add1_out1 = Add1_stage3_sub_cast - Add1_stage3_sub_cast_1;



  assign Gain_mul_temp = 64'sh4189374BC6A7F000 * Add1_out1;
  assign Gain_out1 = Gain_mul_temp[127:112];
  ...
  Compare_To_Constant_block23 u_Compare_To_Constant (.u(v),  // sfix16_En8
