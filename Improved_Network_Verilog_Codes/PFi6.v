// -------------------------------------------------------------
// 
// File Name: C:\Users\Sertan\Desktop\Simulink_Model\Verilog_Codes\Improved_Network_Model\PFi6.v
...
// 
// Module: PFi6
// Source Path: Improved_Network_Model/PFi6
// Hierarchy Level: 1
// Model version: 1.37
// 
// -------------------------------------------------------------
...
module PFi6
  ...
  wire signed [63:0] Add1_in0;  // sfix64_En49
  wire signed [63:0] Add1_sub_cast;  // sfix64_En49
  ...
  assign Add1_in0 =  - (Gain1_out1);
  assign Add1_sub_cast = {{7{Add2_out1[15]}}, {Add2_out1, 41'b00000000000000000000000000000000000000000}};
  assign Add1_out1 = Add1_in0 - Add1_sub_cast;
  ...
  Compare_To_Constant_block38 u_Compare_To_Constant (.u(v),  // sfix16_En8
